...
extension ByteBuffer {
    ...
    //@inlinable
    public mutating func readTLSClientHello() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS ServerHello`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public mutating func readTLSServerHello() -> ReadResult<[UInt8]> {
    ...
    //@inlinable
    public mutating func readTLSEncryptedExtensions() -> ReadResult<[UInt8]> {
    ...
    //@inlinable
    public mutating func readTLSCertificate() -> ReadResult<[UInt8]> {
    ...
    //@inlinable
    public mutating func readTLSCertificateVerify() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS Certificate Verify`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public mutating func readTLSHandshakeFinished() -> ReadResult<[UInt8]> {
...
extension ByteBuffer {
    ...
    //@inlinable
    public func getTLSClientHello() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS ServerHello`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public func getTLSServerHello() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS Encrypted Extension`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public func getTLSEncryptedExtensions() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS Certificate`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public func getTLSCertificate() -> ReadResult<[UInt8]> {
    ...
    /// - returns: A `[UInt8]` value containing the `TLS Certificate Verify`s bytes or `nil` if there wasn't a valid frame available.
    //@inlinable
    public func getTLSCertificateVerify() -> ReadResult<[UInt8]> {
    ...
    internal func getTLSFrameHeader(at: Int) -> ReadResult<(TLSFrame, Int)> {
    ...
    public func getTLS(frame: TLSFrame) -> ReadResult<[UInt8]> {
    ...
    public func getTLSSlice(frame: TLSFrame) -> ReadResult<ByteBuffer> {
        switch self.getTLSFrameHeader(at: self.readerIndex) {
            case .invalidFrame: return .invalidFrame
            case .needMoreData: return .needMoreData
            case .success((let type, let bytesToConsume)):
    ...
    public mutating func readTLS(frame: TLSFrame) -> ReadResult<[UInt8]> {
    ...
    public func getTLSFrame() -> ReadResult<(TLSFrame, [UInt8])> {
        switch self.getTLSFrameHeader(at: self.readerIndex) {
            case .invalidFrame: return .invalidFrame
            case .needMoreData: return .needMoreData
            case .success((let type, let bytesToConsume)):
    ...
    public func getTLSFrameSlice() -> ReadResult<(TLSFrame, ByteBuffer)> {
        switch self.getTLSFrameHeader(at: self.readerIndex) {
            case .invalidFrame: return .invalidFrame
            case .needMoreData: return .needMoreData
            case .success((let type, let bytesToConsume)):
    ...
    public mutating func readTLSFrame() -> ReadResult<(TLSFrame, [UInt8])> {
    ...
    private func optionallyUnwraped<T>(_ result: ReadResult<T>) -> T? {
        switch result {
